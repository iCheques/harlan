...
module.exports = controller => {
    ...
    const relatorioAnalitico = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-icheques-relatorio-analitico@1.0.60/index.js').fail(failAlert));
    ...
    controller.registerCall('harlanVersion', () => '1.0.96');

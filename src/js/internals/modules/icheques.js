...
module.exports = controller => {
    ...
    const notifyCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-notify@1.0.8/index.js').fail(failAlert));

    controller.registerCall('harlanVersion', () => '1.0.47');

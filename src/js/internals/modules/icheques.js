...
module.exports = controller => {
    ...
    const consultaSimplesCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-consulta-simples@1.0.17/index.js').fail(failAlert));
    ...
    controller.registerCall('harlanVersion', () => '1.1.5');

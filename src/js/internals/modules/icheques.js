...
module.exports = controller => {
    ...
    const graficosAnaliticosCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-graficos-analiticos@1.0.39/index.js').fail(failAlert));
    ...
    const relatorioAnalitico = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-icheques-relatorio-analitico@1.0.56/index.js').fail(failAlert));
    ...
    controller.registerCall('harlanVersion', () => '1.0.66');

...
module.exports = controller => {
    ...
    const graficosAnaliticosCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-graficos-analiticos@1.0.26/index.js').fail(failAlert));
    ...
    const relatorioAnalitico = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-icheques-relatorio-analitico@1.0.51/index.js').fail(failAlert));
    ...
    const refinCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-icheques-refin@1.0.71/index.js').fail(failAlert));
    ...
    controller.registerCall('harlanVersion', () => '1.0.26');

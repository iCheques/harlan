...
module.exports = controller => {
    ...
    const veiculosCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-veiculos@1.1.34/index.js').fail(failAlert));
    ...
    controller.registerCall('harlanVersion', () => '1.0.71');

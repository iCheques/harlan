        ...
        controller.serverCommunication.call(controller.endpoint.myIChequesAccountOverview,
            controller.call('loader::ajax', controller.call('error::ajax', {
                ...
                success(response) {
                    ...
                    /*const veiculosCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-veiculos@1.1.26/index.js').fail(failAlert));
                    ...
                    const componenteVeiculosCall = oneTime(() => $.getScript('https://cdn.jsdelivr.net/npm/harlan-credithub-componente-veiculos@1.0.16/index.js').fail(failAlert));
